			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($tournaments as $tournament): ?>
					<tr>
						...
						<td><?php echo h($tournament['Tournament']['title']); ?>&nbsp;</td>
						<td><?php echo h($tournament['Tournament']['division']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $tournament['Tournament']['id']), array('escape' => false)); ?>
